 ...
 *
 * A back-compat `SqliteDashboardRepository` class is re-exported below
 ...
 * wires `SqliteDashboardRepository` into the pre-W6 `IDashboardRepository`
 ...
 */
export class SqliteDashboardRepository implements ILegacyDashboardRepository {
