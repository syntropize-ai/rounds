// Change Event Adapter - webhook payload types and normalization contracts
...
export type WebhookPayload =
  | { source: 'generic'; payload: GenericWebhookPayload }
  | { source: 'github'; payload: GitHubDeploymentPayload };
