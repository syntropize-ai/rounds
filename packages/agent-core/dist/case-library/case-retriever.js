...
function jaccardStrings(a, b) {
    return jaccard(new Set(a.map((s) => s.toLowerCase())), new Set(b.map((s) => s.toLowerCase())));
}
    ...
    search(query) {
        ...
        const scored = cases.map((record) => {
            ...
            const tagScore = queryTags.length > 0
                ...
                : 0;
            const score = WEIGHT_SYMPTOMS * symptomScore +
...
//# sourceMappingURL=case-retriever.js.map