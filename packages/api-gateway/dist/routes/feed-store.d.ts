export type FeedEventType = 'investigation_complete' | 'anomaly_detected' | 'change_impact' | 'incident_created' | 'proactive_investigation' | 'action_executed' | 'approval_requested' | 'approval_resolved' | 'verification_complete';
...
export declare class FeedStore {
    ...
    add(type: FeedEventType, title: string, summary: string, severity: FeedSeverity, investigationId?: string, tenantId?: string): FeedItem;
