// OpenAPI spec for the Investigation API (served at GET /openapi.json)
  ...
  paths: {
    '/investigations': {
      post: {
        ...
        requestBody: {
          required: true,
          content: { 'application/json': { schema: { $ref: '#/components/schemas/CreateInvestigationBody' } } },
        },
        responses: {
          201: { description: 'Investigation created', content: { 'application/json': { schema: { $ref: '#/components/schemas/Investigation' } } } },
      ...
      get: {
        ...
        responses: {
          200: { description: 'List of investigations', content: { 'application/json': { schema: { type: 'array', items: { $ref: '#/components/schemas/InvestigationSummary' } } } } },
          401: { description: 'Unauthorized' },
        },
      },
    },
    '/investigations/{id}': {
      get: {
        ...
        responses: {
          200: { description: 'Investigation detail', content: { 'application/json': { schema: { $ref: '#/components/schemas/Investigation' } } } },
    ...
    '/investigations/{id}/plan': {
      get: {
        ...
        parameters: [{ name: 'id', in: 'path', required: true, schema: { type: 'string' } }],
        responses: {
          200: { description: 'Investigation plan', content: { 'application/json': { schema: { $ref: '#/components/schemas/PlanResponse' } } } },
          404: { description: 'Not found' },
          401: { description: 'Unauthorized' },
        },
      },
    },
    '/investigations/{id}/followup': {
      post: {
        tags: ['Investigations'],
        ...
        requestBody: {
          required: true,
          content: { 'application/json': { schema: { $ref: '#/components/schemas/FollowUpBody' } } },
        },
        responses: {
          201: { description: 'Follow-up created', content: { 'application/json': { schema: { $ref: '#/components/schemas/FollowUpRecord' } } } },
    ...
    '/investigations/{id}/feedback': {
      post: {
        tags: ['Investigations'],
        summary: 'Submit feedback on investigation quality',
        ...
        responses: {
          200: { description: 'Feedback recorded', content: { 'application/json': { schema: { $ref: '#/components/schemas/FeedbackResponse' } } } },
          404: { description: 'Investigation not found' },
          401: { description: 'Unauthorized' },
        },
      },
  ...
  components: {
    schemas: {
      ...
      InvestigationSummary: {
        ...
        properties: {
          id: { type: 'string' },
          status: { type: 'string', enum: ['planning', 'investigating', 'evidencing', 'explaining', 'acting', 'verifying', 'completed', 'failed'] },
          intent: { type: 'string' },
          sessionId: { type: 'string' },
          userId: { type: 'string' },
