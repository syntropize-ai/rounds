...
export class OAuthProvider {
  ...
  getAuthorizationUrl() {
    ...
    const defaultScopes = this.config.provider === 'github' ? ['openid', 'email', 'read:user'] : ['openid', 'email', 'profile']
  ...
  async normalizeGitHub(data, accessToken) {
    ...
    // GitHub may not return email in user object - fetch from emails endpoint
    if (!email) {
